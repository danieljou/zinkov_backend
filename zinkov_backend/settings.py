"""
Django settings for zinkov_backend project.
...
SECRET_KEY = 'django-insecure-ns2dxs6pxh-*)kmik^=m*z*8@@(i_rb7$(09b0rep)*ss-hh_x'
...
ROOT_URLCONF = 'zinkov_backend.urls'
...
WSGI_APPLICATION = 'zinkov_backend.wsgi.application'
